...
import { tools as linearTools } from './connectors/linear.mjs';
...
if (existsSync(join(homedir(), '.antidrift', 'linear.json'))) {
  allTools.push(...linearTools);
}
  ...
  if (method === 'initialize') {
    send({
      ...
      result: {
        ...
        capabilities: { tools: {} },
        serverInfo: { name: 'antidrift-linear', version: '0.1.0' }
      }
    });
