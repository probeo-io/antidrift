...
import { tools as pipedriveTools } from './connectors/pipedrive.mjs';
...
if (existsSync(join(homedir(), '.antidrift', 'pipedrive.json'))) {
  allTools.push(...pipedriveTools);
}
  ...
  if (method === 'initialize') {
    send({
      ...
      result: {
        ...
        capabilities: { tools: {} },
        serverInfo: { name: 'antidrift-pipedrive', version: '0.1.0' }
      }
    });
