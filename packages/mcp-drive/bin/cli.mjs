...
async function writeMcpConfig() {
  ...
  const serverDir = join(cwd, '.mcp-servers', 'drive');
  ...
  if (targets.cowork) {
    const absoluteServerPath = join(cwd, '.mcp-servers', 'drive', 'server.mjs');
    writeDesktopConfig('antidrift-drive', absoluteServerPath);
