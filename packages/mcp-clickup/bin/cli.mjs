...
function writeMcpConfig() {
  ...
  const serverDir = join(cwd, '.mcp-servers', 'clickup');
  ...
  if (targets.cowork) {
    const absoluteServerPath = join(cwd, '.mcp-servers', 'clickup', 'server.mjs');
    writeDesktopConfig('antidrift-clickup', absoluteServerPath);
