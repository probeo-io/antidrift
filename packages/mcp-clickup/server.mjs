...
import { tools as clickupTools } from './connectors/clickup.mjs';
...
if (existsSync(join(homedir(), '.antidrift', 'clickup.json'))) {
  allTools.push(...clickupTools);
}
  ...
  if (method === 'initialize') {
    send({
      ...
      result: {
        ...
        capabilities: { tools: {} },
        serverInfo: { name: 'antidrift-clickup', version: '0.1.0' }
      }
    });
