...
import { tools as vercelTools } from './connectors/vercel.mjs';
...
if (existsSync(join(homedir(), '.antidrift', 'vercel.json'))) {
  allTools.push(...vercelTools);
}
  ...
  if (method === 'initialize') {
    send({
      ...
      result: {
        ...
        capabilities: { tools: {} },
        serverInfo: { name: 'antidrift-vercel', version: '0.1.0' }
      }
    });
