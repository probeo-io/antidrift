...
function writeMcpConfig() {
  ...
  const serverDir = join(cwd, '.mcp-servers', 'hubspot-crm');
  ...
  if (targets.cowork) {
    const absoluteServerPath = join(cwd, '.mcp-servers', 'hubspot-crm', 'server.mjs');
    writeDesktopConfig('antidrift-hubspot-crm', absoluteServerPath);
