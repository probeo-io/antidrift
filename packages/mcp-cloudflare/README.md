...
You'll be prompted for your Cloudflare API token. Create one at [Cloudflare Dashboard > Profile > API Tokens](https://dash.cloudflare.com/profile/api-tokens). Read-only permissions are sufficient.
