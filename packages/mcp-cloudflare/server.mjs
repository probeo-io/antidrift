...
import { tools as cfTools } from './connectors/cloudflare.mjs';
...
if (existsSync(join(homedir(), '.antidrift', 'cloudflare.json'))) {
  allTools.push(...cfTools);
}
  ...
  if (method === 'initialize') {
    send({
      ...
      result: {
        ...
        capabilities: { tools: {} },
        serverInfo: { name: 'antidrift-cloudflare', version: '0.1.0' }
      }
    });
