---
name: onboard
description: Walk a new person through the business. Triggers on "I'm new here", "onboard me", "walk me through", "where do I start", "what is this place"
---

Walks a new person through the business interactively. Reads from the brain repo and presents context conversationally, not as a document dump.
...
1. **Role Check** — ask what they're here to work on
2. **What the company does** — cover the core product and positioning
3. **Customers** — walk through active customers
